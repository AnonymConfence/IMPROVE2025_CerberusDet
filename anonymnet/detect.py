...
import numpy as np
import torch
from anonymnet.data.dataset_images import LoadImages
from anonymnet.models.experimental import attempt_load
from anonymnet.models.net import OurAnonymModel
from anonymnet.utils.checks import check_requirements
...
from anonymnet.utils.metrics import box_iou
from anonymnet.utils.plots import colors, create_label, plot_one_box
from anonymnet.utils.torch_utils import Profile, select_device
...
def run(
    ...
    # Load model
    model: OurAnonymModel = attempt_load(weights, map_location=device, mlflow_url=mlflow_url)  # load FP32 model
