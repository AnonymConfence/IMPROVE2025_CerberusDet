...
import yaml
from anonymnet import val
from anonymnet.data.dataloaders import _create_dataloader
from anonymnet.data.datasets import LoadImagesAndLabels
from anonymnet.evolvers.predefined_evolvers import EVOLVER_TYPES
from anonymnet.models.experimental import attempt_load
from anonymnet.models.net import OurAnonymModel
from anonymnet.trainers.averaging import Averaging
from anonymnet.utils.checks import check_file, check_git_status, check_requirements
from anonymnet.utils.general import check_img_size, colorstr, get_latest_run, increment_path, init_seeds, set_logging
from anonymnet.utils.models_manager import ModelManager
from anonymnet.utils.plots import plot_labels
from anonymnet.utils.torch_utils import select_device
from anonymnet.utils.train_utils import create_data_loaders, get_init_metrics_per_task
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="anonymnet/models/yolov8x.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="data/voc_obj365.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default="data/hyps/hyp.voc_obj365.yaml", help="hyperparameters path")
    ...
    parser.add_argument("--experiment_name", type=str, default="exp", help="MlFlow experiment name")
...
def main(opt):
    ...
    # Train
    if not opt.evolve:
        train(opt.hyp, opt, device, seed=opt.seed)
...
def run(**kwargs):
    # Usage: from anonymnet import train; train.run(imgsz=640, weights='yolov5m.pt')
    opt = parse_opt(True)
