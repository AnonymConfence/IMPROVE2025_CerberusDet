...
from anonymnet.models.common import (
    C2,
    C3,
    C3SPP,
    C3TR,
...
from anonymnet.models.experimental import CrossConv, GhostBottleneck, GhostConv, MixConv2d
from anonymnet.utils.general import make_divisible
from anonymnet.utils.plots import feature_visualization
from anonymnet.utils.tal import dist2bbox, make_anchors
from anonymnet.utils.torch_utils import fuse_conv_and_bn, initialize_weights, model_info, time_sync
...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False, visualize=False):
        ...
        if hasattr(self, "without_head") and self.without_head:
            # pass all saved outputs to anonymnet blocks
            return y
