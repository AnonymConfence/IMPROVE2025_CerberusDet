...
from anonymnet.utils.general import xywh2xyxy
from anonymnet.utils.metrics import bbox_iou
from anonymnet.utils.tal import TaskAlignedAssigner, bbox2dist, dist2bbox, make_anchors
from anonymnet.utils.torch_utils import get_hyperparameter
...
class Loss:
    def __init__(self, model, task_ids, use_soft_labels):  # model must be de-paralleled
        ...
        if hasattr(model, "heads"):  # OurAnonymNetNet
